...
public class FileResource {
    ...
    public ResponseResult<String> upload(@RestForm("file") FileUpload fileUpload) throws IOException {
        uploadFileService.InitFileData(fileUpload);
    ...
    @GET
    @Path("list")
    public ResponsePage<FileList> findList(@QueryParam("page")Integer page,@QueryParam("size")Integer size){
        Page<FileList> fileList = uploadFileService.findAll(page,size);
        return ResponsePage.success(fileList);
    }
