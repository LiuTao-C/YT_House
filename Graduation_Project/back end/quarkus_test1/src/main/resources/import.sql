...
-- ----------------------------
-- Table structure for hazardlog
-- ----------------------------
DROP TABLE IF EXISTS `hazardlog`;
CREATE TABLE `hazardlog`  (
                              `id` int(0) NOT NULL AUTO_INCREMENT,
                              `hazardlevel` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
                              ...
                              `find_date` date NULL DEFAULT NULL,
                              `detail_information` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
                              `registor` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
                              PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hazardlog
-- ----------------------------
...
CREATE TABLE `reportfile`  (
                               ...
                               `document_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `reportfile` VALUES (1, '2ca8ad045ec3464f82c19594ce7ea308.jpg', 'D:\\storefile', 93843, 'jpg', '蓝版图片.jpg', '2024-04-05', '安全部');
INSERT INTO `reportfile` VALUES (2, 'b59dfa8a1d07475cb2a8e1f79d08a3d8.png', 'D:\\storefile', 7074, 'png', '个人签名.png', '2024-04-02', '技术操作部');
INSERT INTO `reportfile` VALUES (3, '2e8e4145fff44313be9be239efae5f35.png', 'D:\\storefile', 72144, 'png', 'logoA.png', '2024-04-27', '管理员');
INSERT INTO `reportfile` VALUES (4, '92387325f6c947888cf316ee869c8a8a.docx', 'D:\\storefile', 210455, 'docx', '学习笔记.docx', '2024-04-30', '航班运营部');
INSERT INTO `reportfile` VALUES (5, 'a15fe6c0c571480092fdb7dd530f11e8.xlsx', 'D:\\storefile', 9365, 'xlsx', '开发情况.xlsx', '2024-04-28', '行政部');
INSERT INTO `reportfile` VALUES (6, 'a4293ac1e896487fb4254c9cd6b20a70.txt', 'D:\\storefile', 121, 'txt', '任务表.txt', '2024-04-14', '安全部');
...
CREATE TABLE `supporter`  (
                              ...
                              `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
                              `date_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'J0o6Kr/DkO4vCV6LiyboKg==', 'admin');
INSERT INTO `user` VALUES (2, 'user', '7dODUYd7MZw2YkqNoioMvw==', 'user');
