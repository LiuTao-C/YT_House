...
import org.example.myproject.service.FruitService;
...
public class FruitServiceTest {
    ...
    @Order(1)
    public void testGet() {
        List<Fruits> list = fruitService.get();
        // 判定非空
    ...
    public void testGetSingle() {
        Fruits fruit = fruitService.getSingle(EXIST_FIRST_ID);
        // 判定非空
    ...
    public void testUpdate() {
        ...
        fruitService.update(EXIST_FIRST_ID, new Fruits(newName));
    ...
    public void testCreate() {
        Fruits fruit = new Fruits("Orange");
